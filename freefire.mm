...
static void INIT_PATCH_NAME(void) {
    ...
    // ═══════════════════════════════════════════════════════════
    // GROUP A: DCKLGOGDPCH - Anti-Cheat Controller (22)
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    // GROUP B: PENGBDFHIIN - Memory Scan & Report (28)
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    // GROUP C: PENGBDFHIIN Native + Extra (5)
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    // GROUP D: External Detection Bypasses (5)
    // ═══════════════════════════════════════════════════════════
    ...
    #else
    // ═══════════════════════════════════════════════════════════
    // ACTIVE OFF - FULL BYPASS (60 offsets)
    // ═══════════════════════════════════════════════════════════
    
    // GROUP A: DCKLGOGDPCH (22)
